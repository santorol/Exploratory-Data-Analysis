...
plot(y=ag$steps,x=ag$dt,type="h", main = "Total Steps per Day", ylab = "Total Steps", xlab = "Date")
```
...
Conclussion - Filling in the missing data did not impact the overal view of the results
